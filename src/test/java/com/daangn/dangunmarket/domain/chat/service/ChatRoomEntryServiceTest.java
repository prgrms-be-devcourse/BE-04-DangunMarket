...
class ChatRoomEntryServiceTest {
    ...
    @Autowired
    ChatRoomEntryService chatEntryService;
    ...
    void addMemberToChat_returnSaneRoomIdAndMemberId() {
        //when
        chatEntryService.addMemberToRoom(savedChatRoom.getId().toString(), existedBuyerId.toString());
    ...
    void addMemberToChat_twoMemberSeveralTime_returnTwoSize() {
        ...
        chatEntryService.addMemberToRoom(savedChatRoom.getId().toString(), existedSellerId.toString());
        chatEntryService.addMemberToRoom(savedChatRoom.getId().toString(), existedSellerId.toString());
    ...
    void removeMemberFromChat_removedMember_notContain() {
        ...
        //when
        chatEntryService.removeMemberFromRoom(savedChatRoom.getId().toString(), existedBuyerId.toString());
    ...
    void isMemberInChat_existedOrNot_returnTrueOrFalse() {
        ...
        //when_then
        assertThat(chatEntryService.isMemberInRoom(savedChatRoom.getId().toString(), existedBuyerId.toString())).isEqualTo(true);
        assertThat(chatEntryService.isMemberInRoom(savedChatRoom.getId().toString(), existedSellerId.toString())).isEqualTo(false);
